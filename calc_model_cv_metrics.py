...
def plot_roc_with_cv(classifier):
    """
    =============================================================
    ...
    # now passing in my classifier
    # from sklearn.ensemble import RandomForestClassifier
    # classifier = RandomForestClassifier(n_estimators=1000, max_depth=24,n_jobs=-1,\
    #     min_samples_leaf=2, min_samples_split=3,random_state=2)
